...
def crop_mammogram():
   ...
   # exam_list_path='C:/Users/ultra/PycharmProjects/breast_cancer_classifier/sample_data/exam_list_before_cropping.pkl'
    ...
    if os.path.exists(output_data_folder):
        ...
        sh.rmtree('C:/Users/ultra/PycharmProjects/breast_cancer_classifier/src/cropping/sample_output/cropped_images')
...
if __name__ == "__main__":
 app.run(host='192.168.1.42', port=2501, debug=True)
...
# parser.add_argument('--exam-list-path', required=True)
  #  parser.add_argument('--cropped-exam-list-path', required=True)
    ...
    crop_mammogram(
        input_data_folder='C:/Users/ultra/PycharmProjects/breast_cancer_classifier/sample_data/images',
        exam_list_path='C:/Users/ultra/PycharmProjects/breast_cancer_classifier/sample_data/exam_list_before_cropping.pkl',
        cropped_exam_list_path='sample_output\cropped_images/cropped_exam_list.pkl',
        output_data_folder='sample_output\cropped_images',
