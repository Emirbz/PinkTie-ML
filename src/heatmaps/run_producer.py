...
# parser.add_argument('--model-path', required=True)
 #   parser.add_argument('--data-path', required=True)
    ...
    parameters = dict(
        ...
        save_heatmap_path=[os.path.join('C:/Users/ultra/PycharmProjects/breast_cancer_classifier/src/cropping/sample_output/heatmaps_'+id_patient, 'heatmap_malignant'),
                           os.path.join('C:/Users/ultra/PycharmProjects/breast_cancer_classifier/src/cropping/sample_output/heatmaps_'+id_patient, 'heatmap_benign')],
    ...
    import src.heatmaps.HeatMap_DatBase as hit
    hit.returnHeatmap(id_patient)
...
if __name__ == "__main__":
    ...
    app.run(host=ip.ip_locale, port=2503, debug=True)
